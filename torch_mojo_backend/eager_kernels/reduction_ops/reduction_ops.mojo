...
# The exceptions are the two routes that read a non-trailing dim interval
# where it lies, allocating nothing: the fp32 SumSpec direct kernel below and
# ArgminSpec's strided-axis kernel in `argreduce_kernels.mojo`.
#
