...
def _vec16_phase[dtype: DType](addr: Int) -> Int:
    ...
    Shared by the log-softmax row pass, the moment reduction and the
    normalization forward kernels; all of them walk a runtime sub-range of a
    buffer whose base phase they do not control.
    """
