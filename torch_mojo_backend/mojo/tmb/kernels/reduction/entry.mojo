...
#
# Raw-pointer calling convention (see elementwise.mojo / tmb/kernels/nn/entry.mojo):
...
# mechanism shared with nn' argmax, so the two ops cannot drift apart in
...
def tmb_call(argv: Argv, argc: Int, err: ErrBuf, errcap: Int) abi("C") -> Int32:
    ...
    try:
        ...
        comptime if _op_on["NormSpec"]():
            ...
            return 0
        comptime if _op_on["NormInfSpec"]():
            _spec_dispatcher4[
                _rowred_spec_into_go[NormInfOp], "a scalar-reduction spec op"
            ](argv, argc)
            return 0
