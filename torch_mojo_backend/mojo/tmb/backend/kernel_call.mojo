...
from tmb.backend.abi import dtype_code
from tmb.backend.loader import Loader, invoke_family
from tmb.kernels.common.op_utils import Arg, Argv, TensorSpec, _f64_slot
...
def init_loader(
    ...
    box.unsafe_write(Loader(root, cache_dir, mojo_exe, toolchain, trace))
