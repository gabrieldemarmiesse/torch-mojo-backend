...
_MATCHES_CPU: dict[str, tuple[str, ...]] = {
    ...
    "argsort": ("float32", "bfloat16", "float16", "int64", "bool"),
    ...
    "bincount": ("int64",),
    "bmm": ("int64",),
    "bucketize": ("float32", "bfloat16", "float16", "int64"),
    ...
    "div_floor_rounding": ("float32", "bfloat16", "float16", "int64"),
    "div_no_rounding_mode": ("bool",),
    "div_trunc_rounding": ("float32", "bfloat16", "float16", "int64"),
    ...
    "msort": ("float32", "bfloat16", "float16", "int64", "bool"),
    ...
    "searchsorted": ("float32", "bfloat16", "float16", "int64"),
    ...
    "topk": ("float32", "bfloat16", "float16", "int64"),
